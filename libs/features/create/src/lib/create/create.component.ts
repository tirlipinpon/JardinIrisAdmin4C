...
import { LoggingService, VersionService, PerformanceService } from '@jardin-iris/core/data-access';
...
export class CreateComponent {
  ...
  constructor() {
    ...
    effect(() => {
      ...
      // Si on est à l'étape 6 (fin du processus), qu'on n'est plus en génération et qu'on a un article
      if (step === 6 && !isGenerating && article && !this.showCompletionDialog) {
